...
type = 'video';
            ...
            function saveToDiskOrOpenNewTab(recordRTC) {
                ...
                document.querySelector('#save-to-disk').parentNode.style.display = 'inline-block';
            ...
            function uploadToPHPServer(fileName, recordRTC, callback) {
                ...
                formData.append('token', window.params.token);
                callback('Uploading recorded-file to server.');
                makeXMLHttpRequest(custom_config.baseUrl + "capture", formData, function(progress) {
                    if (progress !== 'upload-ended') {
                        callback(progress);
                        return;
                    }
                    var initialURL = custom_config.baseUrl + 'uploads/';
